...
const ButtonAction = ({
  ...
  const handleEditProductTwoKeys = (val, key2) => {
    ...
    elementsInfoCopy.products[index]["buttonAction"][key2] = val;
    ...
    <div>
      <div className="mt-1 mb-2">
        ...
        <TextField
          ...
          helperText=""
          value={elementsInfo.products[index].buttonAction.buttonText}
          onChange={(e) =>
        ...
        <FormControlLabel
          control={
            <Switch
              checked={elementsInfo.products[index]?.buttonAction.forWpp}
              onChange={() => {
                handleEditProductTwoKeys(
                  !elementsInfo.products[index]?.buttonAction.forWpp,
                  "forWpp"
                );
              }}
            />
      ...
      {elementsInfo.products[index]?.buttonAction.forWpp ? (
        <>
          <TextField
            ...
            type="number"
            disabled={!elementsInfo.products[index]?.buttonAction.forWpp}
            value={elementsInfo.products[index].buttonAction.wppNumber}
            onChange={(e) =>
          ...
          <TextField
            ...
            disabled={!elementsInfo.products[index]?.buttonAction.forWpp}
            value={elementsInfo.products[index].buttonAction.wppMessage}
            onChange={(e) =>
        ...
        <>
          <TextField
            ...
            value={elementsInfo.products[index].buttonAction.customUrl}
            disabled={elementsInfo.products[index]?.buttonAction.forWpp}
            onChange={(e) =>
